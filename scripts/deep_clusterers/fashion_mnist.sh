...
python -m src.deep_clusterers.train dataset=fashion_mnist training.batch_size=1024 \
...
python -m src.deep_clusterers.train dataset=fashion_mnist training.batch_size=128 \
