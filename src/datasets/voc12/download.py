...
urls = {
    'trval': 'http://host.robots.ox.ac.uk/pascal/VOC/voc2012/VOCtrainval_11-May-2012.tar',
...
def parse_labels(dataset_cfg):
    ...
    labels_root = os.path.join(root_folder, 'VOCdevkit', 'VOC2012', 'ImageSets', 'Main')
    images_root = os.path.join(root_folder, 'VOCdevkit', 'VOC2012', 'JPEGImages')
